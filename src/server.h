...
typedef struct client {
    ...
    /* HSETC field order cache - avoids re-sorting when same fields repeat. */
    void *hsetc_cache;            /* hsetcCache* - cached last HSETC field order */
} client;
...
typedef struct hashTemplate {
    ...
    robj **field_objs;   /* robj wrappers for propagation. */
