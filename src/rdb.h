...
#define RDB_TYPE_HASH_TEMPLATE 27              /* Hash with shared template (HashV2) - full */
#define RDB_TYPE_HASH_TEMPLATE_REF 28          /* Hash with template reference (HashV2) - compact */
